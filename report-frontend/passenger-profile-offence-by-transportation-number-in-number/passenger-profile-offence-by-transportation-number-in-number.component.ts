...
@Component({
  selector: 'app-passenger-profile-offence-by-transportation-number-in-number',
  templateUrl: './passenger-profile-offence-by-transportation-number-in-number.component.html',
  styleUrls: ['./passenger-profile-offence-by-transportation-number-in-number.component.scss'],
})
export class PassengerProfileOffenceByTransportationNumberInNumberComponent {
  form = new FormGroup({});
  model = {};
  ...
  loadReport( transportationNumber, startDate, endDate,reportFormat): void {
    ...
    this.http.get(environment.cmsGateWayRootContext + 'customsOperations/passenger/report/offence/transportationNumber/inNumber/'  + startDate + '/' + endDate + '/'+ transportationNumber +'/'+ reportFormat, {
      headers: headers,
