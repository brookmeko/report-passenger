...
@Component({
  selector: 'app-passenger-profiles-summary-manually-rerouted',
  templateUrl: './passenger-profiles-summary-manually-rerouted.component.html',
  styleUrls: ['./passenger-profiles-summary-manually-rerouted.component.scss'],
})
export class PassengerProfileSummaryManuallyReroutedComponent {
  form = new FormGroup({});
  model = {};
  ...
  loadReport(  startDate, endDate,reportFormat): void {
    ...
    this.http.get(environment.cmsGateWayRootContext + 'customsOperations/passenger/report/rerouted/frequencyRiskLevel/'  + startDate + '/' + endDate  +'/'+ reportFormat, {
      headers: headers,
