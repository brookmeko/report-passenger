...
@Component({
  selector: 'app-passenger-profile-by-risk-criterial-selectivity-in-detail',
  templateUrl: './passenger-profile-by-risk-criterial-selectivity-in-detail.component.html',
  styleUrls: ['./passenger-profile-by-risk-criterial-selectivity-in-detail.component.scss'],
})
export class PassengerProfileByRiskCriterialSelectivityInDetailComponent {
  form = new FormGroup({});
  model = {};
  ...
  loadReport(  startDate, endDate,transportationNumber): void {
    ...
    this.http.get(environment.cmsGateWayRootContext + 'customsOperations/passenger/report/riskCriteria/selectivity/transportationNumber/inDetail/'  + startDate + '/' + endDate  +'/'+ transportationNumber, {
      headers: headers,
