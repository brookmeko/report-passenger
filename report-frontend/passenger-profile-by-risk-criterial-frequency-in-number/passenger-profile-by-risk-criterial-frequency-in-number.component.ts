...
@Component({
  selector: 'app-passenger-profile-by-risk-criterial-frequency-in-number',
  templateUrl: './passenger-profile-by-risk-criterial-frequency-in-number.component.html',
  styleUrls: ['./passenger-profile-by-risk-criterial-frequency-in-number.component.scss'],
})
export class PassengerProfileByRiskCriterialFrequencyInNumberComponent {
  form = new FormGroup({});
  model = {};
  ...
  loadReport(  startDate, endDate,reportFormat): void {
    ...
    this.http.get(environment.cmsGateWayRootContext + 'customsOperations/passenger/report/riskCriteria/frequency/inNumber/'  + startDate + '/' + endDate  +'/'+ reportFormat, {
      headers: headers,
