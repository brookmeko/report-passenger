...
@Component({
  selector: 'app-passenger-profiles-by-risk-selectivity-level-in-detail',
  templateUrl: './passenger-profiles-by-risk-selectivity-level-in-detail.component.html',
  styleUrls: ['./passenger-profiles-by-risk-selectivity-level-in-detail.component.scss'],
})
export class PassengerProfilesByRiskSelectivityLevelInDetailComponent {
  form = new FormGroup({});
  model = {};
  ...
  loadReport(  startDate, endDate,reportFormat): void {
    ...
    this.http.get(environment.cmsGateWayRootContext + 'customsOperations/passenger/report/riskLevel/selectivityLevelInDetail/'  + startDate + '/' + endDate  +'/'+ reportFormat, {
      headers: headers,
