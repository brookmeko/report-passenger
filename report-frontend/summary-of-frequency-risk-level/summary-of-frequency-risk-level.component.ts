...
@Component({
  selector: 'app-summary-of-frequency-risk-level',
  templateUrl: './summary-of-frequency-risk-level.component.html',
  styleUrls: ['./summary-of-frequency-risk-level.component.scss'],
})
export class SummaryOfFrequencyRiskLevelComponent {
  form = new FormGroup({});
  model = {};
  ...
  loadReport(  startDate, endDate,reportFormat): void {
    ...
    this.http.get(environment.cmsGateWayRootContext + 'customsOperations/passenger/report/summary/frequencyRiskLevel/'  + startDate + '/' + endDate  +'/'+ reportFormat, {
      headers: headers,
