...
@Component({
  selector: 'app-passenger-profile-offence-by-transportation-date-in-number',
  templateUrl: './passenger-profile-offence-by-transportation-date-in-number.component.html',
  styleUrls: ['./passenger-profile-offence-by-transportation-date-in-number.component.scss'],
})
export class PassengerProfileOffenceByTransportationDateInNumberComponent {
  form = new FormGroup({});
  model = {};
  ...
  loadReport(  startDate, endDate,reportFormat): void {
    ...
    this.http.get(environment.cmsGateWayRootContext + 'customsOperations/passenger/report/offence/transportationDate/inNumber/'  + startDate + '/' + endDate  +'/'+ reportFormat, {
      headers: headers,
